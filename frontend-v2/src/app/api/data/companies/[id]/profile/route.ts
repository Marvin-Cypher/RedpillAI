...
export async function GET(
  ...
  try {
    ...
    console.log(`[API] Proxying company profile request: ${backendUrlWithParams.toString()}`)
    ...
    if (!response.ok) {
      console.error(`[API] Backend request failed: ${response.status} ${response.statusText}`)
