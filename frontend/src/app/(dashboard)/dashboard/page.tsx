...
import { getAllCompanies, getPortfolioStats, Company, PortfolioStats } from '@/lib/companyDatabase'
import { ChatWithAIButton, AIResearchButton } from '@/components/ai'
import { 
  BarChart3, 
  TrendingUp, 
  Users, 
              ...
              <CardContent>
                {companies.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground mb-6">Add your first portfolio company to get started.</p>
                    <Button 
                      onClick={() => window.location.href = '/companies/new'}
                    >
                      <Plus className="w-4 h-4 mr-2" />
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex items-center space-x-3">
                              <div className="w-12 h-12 bg-gradient-to-r from-primary to-purple-600 rounded-lg flex items-center justify-center text-primary-foreground font-bold">
                          ...
                          <div className="space-y-2 mb-4">
                            <div className="flex justify-between text-sm">
                              ...
                              <span className="font-medium text-foreground">{formatCurrency(company.investment.investment_amount)}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-muted-foreground">Valuation:</span>
                              <span className="font-medium text-foreground">{formatCurrency(company.investment.valuation)}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                              <span className="text-muted-foreground">ARR:</span>
                              <span className="font-medium text-foreground">{formatCurrency(company.metrics.arr)}</span>
                            </div>
                          </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-foreground mb-2">Pipeline View</h3>
                  <p className="text-muted-foreground mb-6">Comprehensive deal flow management coming soon.</p>
                  <Button 
                    onClick={() => window.location.href = '/dealflow'}
                    variant="outline"
                  >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">Portfolio Success Rate</span>
                      <span className="font-semibold text-foreground">
                        {portfolioStats?.total_companies && portfolioStats?.total_companies > 0 
                    ...
                    <Progress 
                      value={portfolioStats?.total_companies && portfolioStats?.total_companies > 0 
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">Average Ownership</span>
                      <span className="font-semibold text-foreground">{portfolioStats?.average_ownership?.toFixed(1) || 0}%</span>
                    </div>
                    
                    <div className="pt-4 border-t border-border">
                      <h4 className="font-medium mb-3 text-foreground">Recent Activity</h4>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Total Portfolio Valuation</div>
                    </div>
